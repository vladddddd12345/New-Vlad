...
import Vendor from "../pageobjects/vendor.login";
import Dashboard from "../pageobjects/vendordashboard";
const pages = {
    vendor : Vendor
}
 ...
 When (/^I input valid email (.+)$/, async (vemail) => {
 ...
 When (/^I input valid password (.+)$/, async (vpassword) => {
